...
| editorIsByColumn          | bool editorIsByColumn() const                                                                                                                      | 是否按列设置编辑器                                  |
| editorIsByRow             | bool editorIsByRow() const                                                                                                                         | 是否按行设置编辑器                                  |
| editorIsByScript          | bool editorIsByScript() const                                                                                                                      | 是否按脚本设置编辑器                                 |
...
| setEditorByColumn         | void setEditorByColumn()const                                                                                                                      | 设置按列设置编辑器                                  |
| setEditorByRow            | void setEditorByRow()const                                                                                                                         | 设置按行设置编辑器                                  |
| setEditorByScript         | void setEditorByScript()const                                                                                                                      | 设置按脚本设置编辑器                                 |
