...
|[有输入焦点的控件](#有输入焦点的控件)||[获得焦点时](#getfocus)<br>[失去焦点时](#lostfocus)|
|[带缺省值的控件](#带缺省值的控件)||[缺省值](#default)|
|[可进行格式转换的控件](#可进行格式转换的控件)||[显示格式](#format)|
|[可进行数据校验的控件(#可进行数据校验的控件)||[校验规则](#validator)|
|[可点击的控件](#可点击的控件)||[点击时](#clicked)|
|[分页控件特有](#分页控件特有)||[切换分页时](#tabchanged)|
|[表格控件特有](#表格控件特有)||[编辑器](#editor)|
